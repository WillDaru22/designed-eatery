/**
 * Filename: Main.java Project: Team Project, Milestone2, main JavaFX GUI interface Authors: Anders
 * Carlsson, William Wilson, Sungjin Park, Jay Park
 *
 * Semester: Fall 2018 Course: CS400 Lecture: 001
 * 
 * Due Date: Before 10pm on October 8, 2018 Version: 1.0
 * 
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        saveToFileBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    saveFileHbox.getChildren().addAll(outputFileNameLbl, inputField,
                                    confirmSaveBtn);
        ...
        totalNutritionObservable = FXCollections.observableArrayList("Calories: " + totCal,
                        "Fat: " + totFat, "Carbohydrates: " + totCarbs, "Fiber: " + totFib,
                        "Protein: " + totPro);
