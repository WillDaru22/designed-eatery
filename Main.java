...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
					...
					confirmFood.setOnAction(new EventHandler<ActionEvent>() {
						...
						public void handle(ActionEvent event) {
							try {
								...
								try {
									// Displays an error box to notify the user than an error of invalid input has
									// occured
		...
		vbox1.setSpacing(12);
		vbox1.getChildren().addAll(foodLbl, filterHbox, listOfFoods, foodCounterHbox, addToMealBtn, addNewFoodBtn,
